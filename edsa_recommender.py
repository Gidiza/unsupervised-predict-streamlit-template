...
def main():
	...
	with st.sidebar:
		selection = option_menu("Main Menu", ["Home", 'visualisation','Top Rated', 'Development team','About Us'], 
		icons=['house', 'pie-chart', 'star-fill','people-fill', 'info-square-fill'], menu_icon="cast", default_index=0)
